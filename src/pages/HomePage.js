        ...
        <section className="homepage-learning-section">
          <div className="homepage-learning-container">
            <div className="homepage-learning-header">
              ...
              <p>
                Mind Sphere CA CMA Academy supports students from early school stages to CA Intermediate with structured guidance, regular practice, and personal attention.
              </p>
            </div>
            ...
            <div className="homepage-learning-grid">
              <div className="homepage-learning-card large">
                ...
                <div className="homepage-learning-content">
                  ...
                  <p>
                    A strong early route for students who want to begin commerce and CA preparation with the right academic direction.
                  </p>
                </div>
              </div>
              ...
              <div className="homepage-learning-card">
                ...
                <div className="homepage-learning-content">
                  ...
                  <p>
                    A focused path for students ready to begin professional CA preparation after completing 12th.
                  </p>
                </div>
              </div>
              ...
              <div className="homepage-learning-card accent">
                ...
                <div className="homepage-learning-content">
                  ...
                  <p>
                    Special classes for 9th and 10th students to build discipline, confidence, and basic commerce thinking early.
                  </p>
                </div>
              </div>
            </div>
